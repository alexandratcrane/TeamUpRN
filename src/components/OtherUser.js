...
const styles = StyleSheet.create({
    mainDiv: { height: 100, width: 400, backgroundColor: '#C4C4C4', borderRadius: 10, flexDirection: 'row', alignItems: 'center', padding: 2, },
    ...
    return (
        ...
        <View style={styles.mainDiv}>
            ...
            <View style={styles.infoDiv}>
                <Text id="username" style={{ fontSize: 18, color: 'black', }}>Username:</Text>
                <Text id="rank" style={{ fontSize: 14, color: 'black', }}>Rank:</Text>
            </View>
